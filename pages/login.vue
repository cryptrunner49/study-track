<template>
    <div class="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900">
        <form @submit.prevent="loginUser"
            ...
            <h1 id="loginHeading" class="text-3xl font-bold text-center dark:text-white">Welcome Back</h1>

            <!-- Email Input -->
            <div>
                <label for="email" class="block mb-1 text-gray-700 dark:text-gray-300">Email Address</label>
            ...
            <!-- Login Button -->
            <button type="submit"
                class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded transition duration-200">Login</button>
